...
/**
 * Thumbnail Processor
 * Runs Sharp / FFmpeg transformations purely in RAM and returns WebP buffers.
 * Sharp runs natively in libuv's C++ thread pool with zero disk I/O.
 */
export async function processThumbnailDirectly({
  type, // 'image' | 'video'
  buffer = null,
  videoUrl = null, // Signed URL or stream source if buffer not provided
  width = 256,
