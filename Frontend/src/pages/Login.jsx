        ...
        {twoFactorRequired ? (
          ...
          >
            <div className="flex flex-col items-center text-center">
              <div className="w-12 h-12 min-[360px]:w-14 min-[360px]:h-14 rounded-2xl bg-accent-soft border border-accent-border flex items-center justify-center mb-3 min-[360px]:mb-4 shadow-accent-glow-sm">
                <ShieldCheck className="text-accent-primary" size={26} />
              </div>
              <h1 className="text-xl min-[360px]:text-2xl font-bold text-slate-900 dark:text-white tracking-tight">
                Two-Factor Authentication
              </h1>
              <p className="text-slate-500 dark:text-slate-400 mt-1 text-xs min-[360px]:text-sm">
                {useRecoveryCode
            ...
            {error && (
              <div className="bg-red-500/10 text-red-600 dark:text-red-400 p-3.5 rounded-xl text-xs min-[360px]:text-sm border border-red-500/20 font-medium">
                {error}
              </div>
            )}

            <form onSubmit={handleTwoFactorSubmit} className="space-y-5 w-full min-w-0">
              {!useRecoveryCode ? (
                <div className="w-full min-w-0">
                  <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 uppercase tracking-wider mb-2 text-center">
                    6-Digit Security Code
                  </label>
                  <div className="flex gap-1 min-[340px]:gap-1.5 sm:gap-2 justify-center py-2 w-full min-w-0" onPaste={handleTwoFactorPaste}>
          ...
          <>
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2.5 px-4 py-2.5 rounded-xl border border-slate-200 dark:border-white/10 bg-slate-100 hover:bg-slate-200 dark:bg-white/[0.06] dark:hover:bg-white/[0.1] text-slate-700 dark:text-slate-200 font-bold text-xs shadow-sm transition-colors"
              >
            <GitHubLogo size={16} />
            Sign in with GitHub
          </button>
