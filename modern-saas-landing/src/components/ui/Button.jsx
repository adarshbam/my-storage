...
const Button = ({ children, variant = "primary", className, ...props }) => {
  ...
  const variants = {
    ...
    secondary:
      "glass-panel text-white hover:bg-white/10 hover:scale-[1.02] active:scale-[0.98] transition-all duration-300",
    ghost:
      "text-slate-300 hover:text-white hover:bg-white/10 transition-all duration-300",
    outline:
      "glass-panel hover:bg-white/10 text-white transition-all duration-300",
    masterclass:
    ...
    glass:
      "glass-card hover:bg-white/[0.08] hover:scale-[1.02] transition-all duration-300 text-white",
  };
